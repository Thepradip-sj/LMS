...
<head>
  ...
  <style>
    ...
    .card-registrar { border-top: 4px solid #9b59b6; }
    ...
    .feature-card.card-registrar:hover .feature-icon { color: #9b59b6; }
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <a href="teacher.php" class="feature-card card-teacher">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <a href="registrar-office.php" class="feature-card card-registrar">
                        <div class="feature-icon" style="color: #9b59b6;">
                            <i class="fa fa-pencil-square"></i>
                        </div>
                        <h4 class="feature-title">Registrar Office</h4>
                        <p class="feature-description">Handle admissions, records, and documentation</p>
                    </a>
                </div>
                
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <a href="class.php" class="feature-card card-class">
                        <div class="feature-icon" style="color: #e67e22;">
                            <i class="fa fa-cubes"></i>
                        </div>
                        <h4 class="feature-title">Classes</h4>
                        <p class="feature-description">Organize and manage class schedules and assignments</p>
                    </a>
                </div>
                
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <a href="section.php" class="feature-card card-section">
                        <div class="feature-icon text-danger">
                            <i class="fa fa-columns"></i>
                        </div>
                        <h4 class="feature-title">Sections</h4>
                        <p class="feature-description">Manage class sections and student groupings</p>
                    </a>
                </div>
                
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <a href="grade.php" class="feature-card card-grade">
                        <div class="feature-icon text-warning">
                            <i class="fa fa-level-up"></i>
                        </div>
                        <h4 class="feature-title">Grades</h4>
                        <p class="feature-description">Configure grade levels and academic standards</p>
                    </a>
                </div>
